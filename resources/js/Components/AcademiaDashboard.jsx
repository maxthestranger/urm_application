...
export default function AcademiaDashboard({myJobs, jobCountAll, jobCountApproved, jobCountPending}) {
    return (
        <>
            <div
            ...
            <div
                ...
                <div className="p-4 md:p-6 xl:p-7.5">
                    <div className="flex items-start justify-between">
                        <div>
                            <h2 className="text-title-sm2 font-bold text-black">My Recent Job Posts</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col gap-7">
                        {
                            myJobs.length !== 0 ? myJobs.map((job, index) => (
                                ...
                                <div className="flex items-center justify-center">
                                    <h4 className="text-lg font-semibold text-gray-500">No Jobs Found</h4>
                                </div>
                            )
                        }
                    </div>
